...
import unittest # pytest does not work for me
import spellcheck
...
# CREATED A CLASS FOR unittest SINCE pytest DID NOT IMPORT
class TestClassample(unittest.TestCase):

    # Do not delete this function. You may change the value assigned to input to test different inputs to your test functions.
    @unittest.fixture # FIX HERE
    def input_value():
        input = alpha
        return input
...
# python3 -m pytest test_spellcheck.py -> for pytest
# python -m unittest -h -> for unittest